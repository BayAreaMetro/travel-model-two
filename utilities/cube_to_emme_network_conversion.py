...
class emme_network_conversion:
    ...
    def parse_transit_line_file(self):
        ...
        bad_vehtypes.to_csv(
            os.path.join(self.emme_network_transaction_folder, 'lines_with_bad_vehicletypes.csv'), index=False)
    ...
    def trim_bad_transit_lines(self, transit_line_df, stop_df):
        ...
        bad_transit_lines_df.to_csv(os.path.join(
            self.emme_network_transaction_folder, "non_routable_transit_lines.csv"), index=False)
    ...
    def write_transit_line_transaction_file(self, node_gdf, link_gdf, transit_line_df, stop_df, transit_system_mode_df, mode_vehtype_xwalk, headway_var):
        ...
        # transit_line_df = self.trim_bad_transit_lines(transit_line_df, stop_df)
    ...
    def prepare_transit_link_extra_attributes(self, transit_line_df, extra_attrib_cols):
    ...
    def write_extra_transit_link_attributes_file(self, transit_line_df):
        print("Writing transit link extra attributes file")

        # cols = ['line_name'] + extra_transit_line_attributes
        transit_line_df, output_col_type_dict = self.prepare_transit_link_extra_attributes(transit_line_df, extra_transit_line_attributes)
    ...
    def make_all_emme_transaction_files(self):
        ...
        self.write_extra_transit_link_attributes_file(transit_line_df)
    ...
    def make_updated_link_attributes_file(self):
        ...
        # writing link file
        link_attributes_to_update = ['TRANTIME', 'CTIM', 'MINUTES']
