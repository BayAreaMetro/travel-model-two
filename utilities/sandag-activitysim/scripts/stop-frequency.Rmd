...
This makes sense. The dominate outcome is 0 out, 0 in, followed by 0 out, 1 in. It is somewhat illogical that 0 out 3 in is more likely than 0 out, 2 in. The calibration *appears* to have modestly overfit this model to the observed data. 
...
The 0 out, 0 in alternative is a bit higher than expected, but the in/out pairs (1 out, 0 in and 0 out, 1 in) are roughly balanced, as expected. 
