...
The parking location choice model does not appeared to be applied correctly. I cannot find records of those with a parking zone that differs from the destination. 
