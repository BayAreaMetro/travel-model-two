...
public class UtilityExpressionCalculator implements VariableTable, Serializable {
    ...
    /**
     * Log zone table values only.
     * 
     * @param localLogger The logger to send the results to.
     * @param zone
     */
    public void logZoneTableValues(Logger localLogger, int zone){
    ...
    public int lookupVariableIndex(String variableName)
    {
