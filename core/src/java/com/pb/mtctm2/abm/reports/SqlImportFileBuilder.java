...
public class SqlImportFileBuilder {
    ...
    public void buildImportFile(String directory, List<String> tables, String outputFileName, String schema, boolean deleteFiles) {
        ...
        try {
            ...
            writer.println();
            writer.println("SELECT 	JTPs.HH_ID,JTPs.TOUR_ID,JTPs.STOP_ID,JTPs.INBOUND,JTPs.TOUR_PURPOSE,JTPs.ORIG_PURPOSE,JTPs.DEST_PURPOSE,JTPs.ORIG_MGRA,JTPs.DEST_MGRA,JTPs.PARKING_MGRA,JTPs.STOP_PERIOD,JTPs.TRIP_MODE,JTPs.NUM_PARTICIPANTS,JTPs.TOUR_MODE,JTPs.TRIP_TIME,JTPs.TRIP_DISTANCE,JTPs.TRIP_COST,JTPs.TRIP_PURPOSE_NAME,JTPs.TRIP_MODE_NAME,JTPs.RECID,JTPs.TRIP_BOARD_TAZ, JTPs.TRIP_ALIGHT_TAZ,JTPs.ORIG_TAZ,JTPs.DEST_TAZ,JTRs.TOUR_PARTICIPANTS");
            ...
            writer.println("		INSERT INTO " + schema + ".TRIP(HH_ID,TOUR_ID,STOP_ID,INBOUND,TOUR_PURPOSE,ORIG_PURPOSE,DEST_PURPOSE,ORIG_MGRA,DEST_MGRA,PARKING_MGRA,STOP_PERIOD,TRIP_MODE,NUM_PARTICIPANTS, TOUR_MODE,TRIP_TIME,TRIP_DISTANCE,TRIP_COST,TRIP_PURPOSE_NAME,TRIP_MODE_NAME,RECID,TRIP_BOARD_TAZ,TRIP_ALIGHT_TAZ,ORIG_TAZ,DEST_TAZ,PERID,HOUSEHOLD_SERIAL_NO,PNUM,AGE,SEX,MILITARY,PEMPLOY,PSTUDENT,PTYPE,EDUC,GRADE,OCCCEN1,INDCEN,WKW,WKHP) "); 	 
            writer.println("		SELECT JTT.HH_ID,JTT.TOUR_ID,JTT.STOP_ID,JTT.INBOUND,JTT.TOUR_PURPOSE,JTT.ORIG_PURPOSE,JTT.DEST_PURPOSE,JTT.ORIG_MGRA,JTT.DEST_MGRA,JTT.PARKING_MGRA,JTT.STOP_PERIOD,JTT.TRIP_MODE,JTT.NUM_PARTICIPANTS, JTT.TOUR_MODE,JTT.TRIP_TIME,JTT.TRIP_DISTANCE,JTT.TRIP_COST,JTT.TRIP_PURPOSE_NAME,JTT.TRIP_MODE_NAME,JTT.RECID,JTT.TRIP_BOARD_TAZ, JTT.TRIP_ALIGHT_TAZ,JTT.ORIG_TAZ,JTT.DEST_TAZ,SP.PERID,SP.HOUSEHOLD_SERIAL_NO,SP.PNUM,SP.AGE,SP.SEX,SP.MILITARY,SP.PEMPLOY,SP.PSTUDENT,SP.PTYPE,SP.EDUC,SP.GRADE,SP.OCCCEN1,SP.INDCEN,SP.WKW,SP.WKHP ");
            ...
            writer.println();
            writer.println("INSERT INTO " + schema + ".TRIP(HH_ID,TOUR_ID,STOP_ID,INBOUND,TOUR_PURPOSE,ORIG_PURPOSE,DEST_PURPOSE,ORIG_MGRA,DEST_MGRA,PARKING_MGRA,STOP_PERIOD,TRIP_MODE,NUM_PARTICIPANTS, TOUR_MODE,TRIP_TIME,TRIP_DISTANCE,TRIP_COST,TRIP_PURPOSE_NAME,TRIP_MODE_NAME,RECID,TRIP_BOARD_TAZ,TRIP_ALIGHT_TAZ,ORIG_TAZ,DEST_TAZ,PERID,HOUSEHOLD_SERIAL_NO,PNUM,AGE,SEX,MILITARY,PEMPLOY,PSTUDENT,PTYPE,EDUC,GRADE,OCCCEN1,INDCEN,WKW,WKHP)");
            writer.println("SELECT ITT.HH_ID,ITT.TOUR_ID,ITT.STOP_ID,ITT.INBOUND,ITT.TOUR_PURPOSE,ITT.ORIG_PURPOSE,ITT.DEST_PURPOSE,ITT.ORIG_MGRA,ITT.DEST_MGRA,ITT.PARKING_MGRA,ITT.STOP_PERIOD,ITT.TRIP_MODE,1,ITT.TOUR_MODE,ITT.TRIP_TIME,ITT.TRIP_DISTANCE,ITT.TRIP_COST,ITT.TRIP_PURPOSE_NAME,ITT.TRIP_MODE_NAME,ITT.RECID,ITT.TRIP_BOARD_TAZ, ITT.TRIP_ALIGHT_TAZ,ITT.ORIG_TAZ,ITT.DEST_TAZ,SP.PERID,SP.HOUSEHOLD_SERIAL_NO,SP.PNUM,SP.AGE,SP.SEX,SP.MILITARY,SP.PEMPLOY,SP.PSTUDENT,SP.PTYPE,SP.EDUC,SP.GRADE,SP.OCCCEN1,SP.INDCEN,SP.WKW,SP.WKHP ");
