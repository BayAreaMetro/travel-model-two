...
Usage: python create_emme_network.py
...
def init_emme_project(root, title, port=59673, overwrite=False):
    ...
    print("Creating Emme project folder with name: {}".format(title))
    ...
    print("Creating Emmebank with dimensions {}".format(dimensions))
...
def import_modes(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing modes from {}".format(emme_mode_transaction_file))
    if modeller is None:
...
def import_network(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing network from {}".format(emme_network_transaction_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
...
def import_extra_node_attributes(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing node attributes from {}".format(extra_node_attr_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
...
def import_extra_link_attributes(input_dir, modeller, scenario_id, update=False):
    ...
    Returns: None
    """
    print("importing link attributes from {}".format(extra_link_attr_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
...
def import_vehicles(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing transit vehicles from {}".format(emme_vehicle_transaction_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
...
def import_transit_time_functions(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing transit time functions from {}".format(emme_transit_time_function_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
...
def import_transit_lines(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing transit network from {}".format(emme_transit_network_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
...
def import_extra_transit_line_attributes(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing extra transit line attributes from {}".format(extra_transit_line_attr_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
    import_extra_attributes_tool_path = "inro.emme.data.extra_attribute.import_extra_attributes"
...
def import_extra_transit_segment_attributes(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing extra transit segment attributes from {}".format(extra_transit_segment_attr_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
    import_extra_attributes_tool_path = "inro.emme.data.extra_attribute.import_extra_attributes"
...
def import_station_attributes(input_dir, modeller, scenario_id):
    ...
    Returns: None
    """
    print("importing station attributes from {}".format(station_extra_attributes_file))
    if modeller is None:
        modeller = _m.Modeller()
    scenario = modeller.emmebank.scenario(scenario_id)
