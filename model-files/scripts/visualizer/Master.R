...
.libPaths(R_LIBRARY)
source(paste(ABM_DIR, "CTRAMP/scripts/visualizer/_SYSTEM_VARIABLES.R", sep = "/"))
...
writeLines(template.html, file.path(ABM_OUTPUT_DIR, paste(OUTPUT_HTML_NAME, ".html", sep = "")))
